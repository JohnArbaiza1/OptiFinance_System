...
public class MiembroEmpresaQueries : IQueriesString<MiembroEmpresa>
{
    public string Insert { get; } = "INSERT INTO miembros_empresa " + 
    ...
    public string Update { get; } = "UPDATE miembros_empresa SET " +
                                    ...
                                    "WHERE id = @id";
    public string Delete { get; } = "DELETE FROM miembros_empresa WHERE id = @id";
    public string FindById { get; } = "SELECT id, nombres, apellidos, alias, dui, correo_electronico, telefono, direccion, id_empresa FROM miembros_empresa WHERE id = @id";
    public string SelectAll { get; } = "SELECT id, nombres, apellidos, alias, dui, correo_electronico, telefono, direccion, id_empresa FROM miembros_empresa WHERE id_empresa = @id_empresa";
    ...
    public List<SqlParameter> UpdateParameters(MiembroEmpresa entity)
    {
        List<SqlParameter> parameters = new()
        {
            new("@nombres", entity.Nombres),
